...
# 1998-07-12 fl   Read/write 16-bit image as mode I (0.4)
...
# 2008-08-13 fl   Added tRNS support for RGB image
    ...
    def seek(self, frame):
        ...
        for f in range(self.__frame + 1, frame + 1):
            try:
                ...
                msg = "no more image in APNG file"
...
def _save(im, fp, filename, chunk=putchunk, save_all=False):
    ...
    if mode == "P":
        ...
        #
        # attempt to minimize storage requirements for palette image
