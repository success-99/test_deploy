...
OPEN_INFO = {
    ...
    # JPEG compressed image handled by LibTiff and auto-converted to RGBX
    # Minimal Baseline TIFF requires YCbCr image to have 3 SamplesPerPixel
...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def _seek(self, frame):
        ...
        while len(self._frame_pos) <= frame:
            if not self.__next:
                msg = "no more image in TIFF file"
                raise EOFError(msg)
            logger.debug(
    ...
    def _setup(self):
        ...
        # old style jpeg compression image most certainly are YCbCr
        ...
        if self.use_load_libtiff:
            ...
            # so large g4 image will fail if we use that
            # function.
            #
            ...
            # YCbCr image with new jpeg compression with pixels in one plane
...
def _save(im, fp, filename):
    ...
    # required for color libtiff image
