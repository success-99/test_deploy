...
urlpatterns = [
    ...
    path('admin-view-classes', views.admin_classes_view, name='admin-view-classes'),
    path('admin-add-class', views.admin_add_classes_view, name='admin-add-class'),
    path('delete-class/<uuid:pk>', views.delete_class_view, name='delete-class'),
    path('update-class/<uuid:pk>', views.admin_update_class_view, name='update-class'),
